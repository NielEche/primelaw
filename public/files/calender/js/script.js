...
$(function () {
    function showEvent(eventDate) {
        ...
        if (storedEvents == null) {
            $('.events-today').html('<h5 class="text-center">No Appointment found</h5 class="text-center">');
        } else {
    ...
    function removeEvent(id) {
        ...
        if (storedEvents != null) {
            ...
            $('.toast-body').html('Your Appointment has been removed');
            $('.toast').toast('show');
        }
    }
    ...
    $(document).on('click', '.showEvent', function () {
        ...
        // if($('#appointment').hasClass('d-none')){
            // $('#appointment').removeClass
        // }
        // $('#appointment').toggle('visible');
        ...
        var selectedDate = year + '/' + month + '/' + $(this).text();
    ...
    $(document).on('click', '#createEvent', function () {
        ...
        $('.error').remove();
        if (eventText == '') {
            $('.events-input').append(`<span class="error">Please enter details</span>`);
        ...
        if (valid) {
            ...
            $('#eventTxt').val('');
            $('.toast-body').html('Your Appointment have been added');
            $('.toast').toast('show');
            showEvent(eventDate);
        }
    })
