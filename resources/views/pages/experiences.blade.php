...
<main class="content-row">
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                <p class="fw-35">We have also been involved in the settlement of several community related issues arising from the purchase and development of landed properties by our clients.</p>
            </div>
        </div>
        <div class="row">
            <div class="col">
            ...
            <div class="row">
                <div class="col-lg-6 pad-5 bg-white">
                    <div class="full-block-04__content mt-3 ">
                        <h2 class="full-block-04__title" style="font-size: 22px;">In the recent past, the firm has been involved in;</h2>
                        <div class="full-block-04__text">
                            <p class=" fw-35" style="font-size: 17px;">We provide litigation and advisory services to:</p>
                        </div>
                        <div class="module_skills module_skills-process">
                            <div class="module_inner">
                                <div class="shortcode_skills">
                                    ...
                                    <p class="fw-35">We have obtained the consent of the companies mentioned herein to provide this information and would be willing to provide any references or specific information which you may require.</p>
                                </div>
                            </div>
                        </div>
                    </div>
